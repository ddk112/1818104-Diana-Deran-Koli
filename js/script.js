const ApiKey = "6f7396b61a744ec39d10022018931d09";
                ...
                btn.onclick = (event) => {
                    ...
                    fetch(url, fetchHeader)
                        ...
                        .then(resData => {
                            dataModal = `
                            <tr>
                                <td><img src="${resData.crestUrl}"  alt="" width="100px" align="center"></td>
                            </tr>
                            <br><p>Nama Singkat &emsp;: ${resData.shortName} /&nbsp;${resData.tla}<br>
                            Berdiri &emsp;&emsp;&emsp;&emsp;&nbsp;: ${resData.founded} <br>
                            Markas  &emsp;&emsp;&emsp;&emsp;: ${resData.venue} <br>
                            Alamat  &emsp;&emsp;&emsp;&emsp;: ${resData.address} <br>
                            No.Tlp  &emsp;&emsp;&emsp;&emsp;&nbsp;: ${resData.phone} <br>
                            Website &emsp;&emsp;&emsp;&nbsp;&nbsp;: ${resData.website} <br>
                            Email   &emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;: ${resData.email} <br>
                            Club Color   &emsp;&emsp;&nbsp;: ${resData.clubColors} <br>
                            </p>`
                            console.log(resData);
                            document.getElementById("nama-tim").innerHTML = resData.name;
